...
namespace ShadowedTextBox
{
    public class ShadowedTextBox : TextBox
    {
        ...
        //----------------------------------- new
        public enum Show {  Focus, OnlyEmpty }
        public Show ShowLabel  // here I get an error "Expected class, delegate, enum, interface or struct"
        {
            get { return (Show)GetValue(ShowLabelProperty); }
            set { SetValue(ShowLabelProperty, value); }
        }

        public static readonly DependencyProperty ShowLabelProperty =
            DependencyProperty.Register("ShowLabel", typeof(Show), typeof(ShadowedTextBox),
            new PropertyMetadata(Show.Focus));
        //-----------------------------------------------------
        public string Label
        {
        ...
        {
            if (((ShadowedTextBox)elem).HasText || (elem.IsFocused && ((ShadowedTextBox)elem).HasText))
            {
